...
Jikalau seseorang mengatakan mengenal Allah, tetapi tidak mengetahui kebenaran (truth), maka hal tersebut adalah kemerosotan. Oleh sebab itu, kita harus mengenal Gambar Kehendak Allah dengan benar dan mempunyai iman yang sesuai dengan kehendak Allah.`,
    weight: "0,384 kg",
    isbn: "978-979-18104-6-3",
    size: "15,7 x 22,9 cm",
    pages: 180,
    stock: "Tersedia",
    price: 80000,
...
Saya merekomendasikan buku ini kepada para orang kudus yang mengemban harapan dan kebenaran di dalam hati mereka supaya menjalani kehidupan rohaniah yang lebih nyata lagi.`,
...

  {
    ...
    Dengan demikian, roh jiwa harus menemukan orang yang peduli terhadap roh jiwa selama berada di muka bumi. Sebab kalau tidak, pada hari roh jiwa berpisah dengan tubuh, roh jiwa seperti anak yatim piatu yang ditinggalkan. Kehidupan Kekristenan menunjukkan kehidupan untuk memperoleh pengetahuan akan adanya roh jiwa, dan hidup ikut serta dalam kemuliaan-Nya juga.`,
    weight: "0,236 kg",
    isbn: "978-979-98113-3-2",
    size: "15,7 x 22,9 cm",
    pages:"136",
    stock: "Tersedia",
    price: 60000,
...

  {
    ...
    Melalui pengajaran-pengajaran mendalam dari Alkitab, buku ini memaparkan secara gambling pengetahuan penulisnya yang berasal dari pengalaman-pengalaman pribadinya yang luas, dan juga mendasarkan riset-riset yang dikhususkan. Hasilnya ialah penyingkapan pelbagai faktro nyata yang membayangi roh dan jiwa manusia sehingga menggugah banyak orang-orang percaya.
    Hendaklah mereka yang hidup di dalam kegelapan membaca buku ini dan hendaklah mereka disemangati untuk menjadi berkemenangan. Marilah kita hidup berkemenangan. Marilah kita tanggalkan kegelapan dan kenakan persenjataan terang. Marilah kita menjalani kehidupan yang kudus sejati dan tulus murni!`,
    weight: "-",
    isbn:"978-979-98133-7-4",
    size:" 15,7 x 22,9 cm",
    pages:"145",
    stock:"Tersedia",
    price: 60000,
...

  {
    ...
    Ketika kita menyukseskan hubungan dengan Allah kita dapat menggenapi keharmonisan dengan Allah. Hal itu menjadi kebahagiaan kekal bagi kita.`,
    weight: "0,356 kg",
    isbn: "978-979-18104-4-9",
    size: "15,7 x 22,9 cm",
    pages: 212,
    stock: "Tersedia",
    price: 100000,
...

  {
    ...
    Jika orang berpura-pura mengenal Allah tetapi tidak mengenal Yesus, ia tidak mempunyai hidup; jika ia berpura-pura mengenal Yesus tapi tidak mengenal Allah ia tidak memiliki hidup kekal.
    Melalui buku ini kita akan lebih dalam lagi mengenal Allah Bapa, Anak Allah dan Allah Roh Kudus berdasarkan Alkitab, ketimbang doktrin dan dogma.`,
    weight: "0,284 kg",
    isbn: " 978-979-98113-4-9",
    size: "15,7 x 22,9 cm",
    pages: 168,
...

  {
    ...
    Hal yang penuh harapan ialah kembali kepada Alkitab saja. Apabila orang menghentikan kuasa yang tidak terbatas dari Roh Kudus dan membelenggu Alkitab dengan teori-teori yang dogmatis, Gereja Kristus akan turun martabatnya dan hanya merupakan perhimpunan moral saja. Itulah sebabnya mengapa kita harus kembali kepada Alkitab. Lalu Allah akan bekerja atas semua janji dan pernyataan dari Alkitab dan kita akan merasakan kuasa-Nya yang sungguh dahsyat itu. Marilah kita kembali kepada Alkitab!`,
    weight: "-",
    isbn: " 978-979-98113-6-3",
    size: "15,7 x 22,9 cm",
    pages: 122,
    stock: "Tersedia",
    price: 60000,
...

  {
    ...
    Allah yang kita percayai dan tempat kita bergantung adalah yang ada dengan Sendiri-Nya, unik dan kekal. Tetapi, berapa banyak orang yang mengenal nama yang begitu penting saat ini? Banyak orang binasa karena mereka tidak mengenal nama Allah itu, dan yang lainnya diselamatkan karena mereka berseru kepada nama itu. Gereja bersekutu demi nama Allah itu, dan menyembah nama-Nya. Gereja memuji nama-Nya dan berdoa dalam nama itu.
    Penyembahan tanpa nama itu merupakan penyembahan berhala, doa tanpa nama itu adalah mantera orang kafir, kehidupan rohani tanpa nama itu merupakan takhyul.`,
    weight: " 0,254 kg",
    isbn: " 978-979-98113-1-8",
    size: "15,7 x 22,9 cm",
    pages: 190,
    stock: "Tersedia",
    price: "100000"
...

  {
    ...
    Kehidupan Kekristenan menunjukkan kehidupan untuk memperoleh pengetahuan akan adanya roh jiwa, dan hidup ikut serta dalam kemuliaan-Nya juga.`,
    weight: "0,464 kg",
    isbn: "978-979-18104-2-5",
    size: "15,7 x 22,9 cm",
    page: 284,
    stock: "Tersedia",
    price: 100000,
...

  {
    ...
    Sebelum menentukan apakah secara teologis atau secara Alkitabiah, buku ini akan mengungkapkan berbagai persoalan yang dihadapi oleh manusia dalam realitasnya. Bukankah hal yang unggul, bahwa seumur hidup kita menang karena mengenal kebenaran daripada kalah karena tidak memakai kuasa besar yang kita miliki?
    Banyak pengalaman diperoleh siapapun, dimanapun dan kapanpun, saya beranggapan buku ini akan banyak membantu dalam menolong penggembalaan yang ada pada garis depan dan dapat menolong kehidupan pribadi orang-orang kudus dengan mendorong mereka untuk menjaga diri sendiri dan menang atas Iblis.
    Demonologi terbagi ke dalam jilid 1, 2 dan 3. Jika Anda membaca Demonologi jilid pertama: Siapakah iblis? Bacalah juga jilid kedua yaitu: Siapakah roh-roh penyesat? Dan kemudian mohon baca pula jilid ketiga, yaitu: Siapakah roh-roh najis atau roh-roh jahat atau setan-setan (=demon)? Hendaklah saudaraku semua yang membaca buku itu menang! Marilah kita memuliakan Tuhan seumur hidup kita sebagai pemenang. Itulah perintah Tuhan.`,
    weight: "0,288 kg",
    isbn: "978-979-98113-0-1",
    size: "15,7 x 22,9 cm",
    pages: 159,
    stock: "Tidak Tersedia",
    price: "-"
...

  {
    ...
    Siapapun yang membaca buku ini serta melakukan sesuai pengungkapan buku ini, ia akan disertai dengan tanda-tanda dalam nama Yesus, dan roh-roh najis pergi terusir dengan satu teriakan.`,
    weight: "0,384 kg",
    isbn: "978-979-98113-2-5",
    size: "15,7 x 22,9 cm",
    pages: 349,
    stock: "Tersedia",
    price: 150000,
...

  {
    ...
    Perilaku manusia muncul dari keadaan hati, dan keadaan hati muncul dari roh. Jika roh itu tidak dipimpin dan diajar oleh Tuhan Yesus, maka ia akan mengembara seperti yatim piatu.
    Segala penyakit dan kejatuhan ada kaitannya dengan roh-roh najis. Roh-roh najis bersandar sangat erat kepada roh-roh penyesat. Siapakah roh-roh penyesat itu? Roh-roh penyesat ialah malaikat-malaikat yang berwatak dasar berubah sifatnya. Tetapi oleh karena tidak mengenal roh-roh penyesat itu, maka keadaan dan persoalah yang mereka hadapi berdampak dalam kehidupannya.
    Penyakit kronis atau kebiasaan yang sudah lama seringkali tidak dapat disembuhkan dan diubahkan, padahal dengan gampang semuanya itu dapat diatasi dan disembuhkan dengan mengenal betul siapakah roh-roh penyesat itu.`,
    weight: " 0,336 kg",
    isbn: "978-979-18104-2-5",
    size: "15,7 x 22,9 cm",
    pages: 234,
